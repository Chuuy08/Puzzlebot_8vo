...
def generate_launch_description():
    ...
    declare_x_arg = DeclareLaunchArgument('x', default_value='0.0', description='X position of the Map_DT model')
    declare_y_arg = DeclareLaunchArgument('y', default_value='0.0', description='Y position of the Map_DT model')
    declare_z_arg = DeclareLaunchArgument('z', default_value='0.0', description='Z position of the Map_DT model')
    declare_yaw_arg = DeclareLaunchArgument('yaw', default_value='0.0', description='Yaw angle of the Map_DT model')
    ...
    gazebo_media_path = os.path.join(gazebo_models_path, 'media', 'materials')
    map_dt_sdf_path = os.path.join(gazebo_models_path, 'Map_DT', 'model.sdf')
