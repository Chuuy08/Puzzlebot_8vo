...
class FramePublisher(Node):
    def __init__(self):
        ...
        q = transforms3d.euler.euler2quat(0, 0, 0) # Input euler2quaternion(roll, pitch, yaw), output q=(w, x, y, z)
        ...
        q2 = transforms3d.euler.euler2quat(1.57, 1.57, 0) # Input euler2quaternion(roll, pitch, yaw), output q=(w, x, y, z)
