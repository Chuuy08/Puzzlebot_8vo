...
def generate_launch_description():
    ...
    # Localisation node con remap: el robot real publica VelocityEncR/L
    # pero el nodo espera wr/wl — el remap los conecta sin tocar el codigo
    ...
    # joint_state_publisher publica posicion de ruedas para visualizacion en RViz
